...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '"><div class="modal-body inner"/><div class="modal-footer"><a class="btn btn-default " href="javascript:void(0);" data-dismiss="modal">取消</a> <a href="javascript:void(0);" class="btn btn-default " data-action="1">确定</a></div></div>').appendTo(this.options.appendTo).hide();
