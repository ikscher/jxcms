        ...
        <div class="col-2 col-left mr6" style="width:560px;height:352px;">
            ...
            <table width="100%"  class="table  table-condensed center">
                <tr>
                    ...
                    <td class="y-bg">
                        <textarea name="info[name]" rows="2" cols="20" id="name" class="form-control" style="height:100px;width:460px;max-width: 460px;"></textarea>
                        <div id="nameTips"></div>
                    </td>
                </tr>
                <tr>
                    <th><?php echo $this->lang->line('description') ?>：</th>
                    <td class="y-bg"><textarea name="info[description]" maxlength="255" class="form-control" style="width:460px;max-width: 460px;height:100px;"></textarea></td>
                </tr>
            </table>
        </div>
...
<script type="text/javascript">
    ...
    var title ="<?php echo $this->lang->line('add_type');?>";
    ...
    $("#name").click(function(){
     ...
     $("#dosubmit").click(function(){
        ...
        $.ajax({
            type:'post',
            url:'?d=content&c=type_manage&m=add',
            dataType:'text',
            data:$("input[type='submit'],textarea,input[type='checkbox']:checked"),
            success:function(){
                $.scojs_confirm({
                    content: "<?php echo $this->lang->line('addfinished');?>",
                    action: function() {
                       this.close();
                   }
                }).show();
