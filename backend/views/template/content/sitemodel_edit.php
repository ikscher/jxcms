...
<div class="pad_10">
    ...
    <!--<form action="?d=content&c=sitemodel&m=edit" method="post" id="myform">-->
        <fieldset>
            ...
            <table width="100%"  class="table  table-condensed center" >
                <tr>
                    ...
                    <td class="y-bg"><input type="text" class="form-control input-sm width_20" name="info[name]" id="name" size="30" value="<?php echo $r['name'];?>"/><div id="nameTips"></div></td>
                </tr>
                <tr>
                    <td><?php echo $this->lang->line('model_tablename') ?>：</td>
                    <td class="y-bg"><input type="text" class="form-control input-sm width_20" name="info[tablename]" id="tablename" size="30" value="<?php echo $r['tablename'];?>" /><div id="tablenameTips"></div></td>
                </tr>
                <tr>
                    <td><?php echo $this->lang->line('description') ?>：</td>
                    <td class="y-bg"><input type="text" class="form-control input-sm width_20" name="info[description]" id="description"  size="30" value="<?php echo $r['description'];?>"/><div id="descTips"></div></td>
                </tr>
            </table>
        </fieldset>
        <div class="bk15"></div>
        <fieldset>
            ...
            <table width="100%"  class="table  table-condensed center">
                <tr>
                    ...
                    <td>
                        <?php echo $this->form->select($style_list, $r['default_style'], 'name="info[default_style]" id="default_style" onchange="load_file_list(this.value)"', $this->lang->line('please_select')) ?> 
                        <div id="templateTips"></div>
                    </td>
                </tr>
                <tr>
                    <td width="200"><?php echo $this->lang->line('category_index_tpl') ?>：</td>
                    <td  id="category_template"><?php echo $this->form->selectTemplate($r['default_style'],'content', $r['category_template'], 'name="setting[category_template]" id="template_category"', 'category')?>
                    </td>
                </tr>
                <tr>
                    <td width="200"><?php echo $this->lang->line('category_list_tpl') ?>：</td>
                    <td  id="list_template"><?php echo $this->form->selectTemplate($r['default_style'],'content', $r['list_template'], 'name="setting[list_template]" id="template_list"', 'list')?>
                    </td>
                </tr>
                <tr>
                    <td width="200"><?php echo $this->lang->line('content_tpl') ?>：</td>
                    <td  id="show_template"><?php echo $this->form->selectTemplate($r['default_style'],'content', $r['show_template'], 'name="setting[show_template]" id="template_show"','show')?>
                    </td>
                </tr>
            </table>
        </fieldset>
...
<!--        <fieldset>
        ...
        <input type='hidden' name="modelid" value="<?php echo $r['modelid'];?>" />
...
<script language="JavaScript">
    ...
    function load_file_list(id) {
     ...
     $("#dosubmit").click(function(){
        ...
        $.ajax({
            type:'post',
            url:'?d=content&c=sitemodel&m=edit',
            dataType:'text',
