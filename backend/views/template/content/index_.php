...
.showMsg h5{background-image: url(../system/public/images/msg/msg.png);background-repeat: no-repeat; color:#fff; padding-left:35px; height:25px; line-height:26px;*line-height:28px; overflow:hidden; font-size:14px; text-align:left}
...
<div class="showMsg" style="text-align:center">
    ...
    <div class="content">
	<input type="text" size="41" id="cat_search" value="<?php echo $this->lang->line('search_category');?>" onfocus="if(this.value == this.defaultValue) this.value = ''" onblur="if(this.value.replace(' ','') == '') this.value = this.defaultValue;">
    <ul id="search_div"></ul>
	</div>
</div>
