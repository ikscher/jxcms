            ...
            <div id="div_setting_2" class="contentList pad-10 hidden">
                <table width="100%" class="table   table-hover">
                    <tr>
                        ...
                        <td>
                            <input type='radio' name='setting[ishtml]' value='1' <?php if ($setting['ishtml']) echo 'checked'; ?> onClick="$('#category_php_ruleid').css('display','none');$('#category_html_ruleid').css('display','');$('#tr_domain').css('display','');"> <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='setting[ishtml]' value='0' <?php if (!$setting['ishtml']) echo 'checked'; ?>  onClick="$('#category_php_ruleid').css('display','');$('#category_html_ruleid').css('display','none');$('#tr_domain').css('display','none');"> <?php echo $this->lang->line('no'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo $this->lang->line('html_show'); ?>：</td>
                        <td>
                            <input type='radio' name='setting[content_ishtml]' value='1' <?php if ($setting['content_ishtml']) echo 'checked'; ?> onClick="$('#show_php_ruleid').css('display','none');$('#show_html_ruleid').css('display','')"> <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='setting[content_ishtml]' value='0' <?php if (!$setting['content_ishtml']) echo 'checked'; ?>  onClick="$('#show_php_ruleid').css('display','');$('#show_html_ruleid').css('display','none')"> <?php echo $this->lang->line('no'); ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><div id="category_php_ruleid" style="display:<?php if ($setting['ishtml']) echo 'none'; ?>">
                                <?php
                                echo $this->form->urlrule('content', 'category', 0, $setting['category_ruleid'], 'name="category_php_ruleid"');
                                ?>
                            </div>
                            <div id="category_html_ruleid" style="display:<?php if (!$setting['ishtml']) echo 'none'; ?>">
                                <?php
                                echo $this->form->urlrule('content', 'category', 1, $setting['category_ruleid'], 'name="category_html_ruleid"');
                                ?>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><div id="show_php_ruleid" style="display:<?php if ($setting['content_ishtml']) echo 'none'; ?>">
                                <?php
                                echo $this->form->urlrule('content', 'show', 0, $setting['show_ruleid'], 'name="show_php_ruleid"');
                                ?>
                            </div>
                            <div id="show_html_ruleid" style="display:<?php if (!$setting['content_ishtml']) echo 'none'; ?>">
                                <?php
                                echo $this->form->urlrule('content', 'show', 1, $setting['show_ruleid'], 'name="show_html_ruleid"');
                                ?>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type='radio' name='setting[create_to_html_root]' value='1' <?php if ($setting['create_to_html_root']) echo 'checked'; ?> > <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type='radio' name='setting[create_to_html_root]' value='0' <?php if (!$setting['create_to_html_root']) echo 'checked'; ?> > <?php echo $this->lang->line('no'); ?>
            ...
            <div id="div_setting_4" class="contentList pad-10 hidden">
                <table width="100%" class="table   table-hover ">
                    ...
                    <tr>
                        ...
                        <td><textarea name='setting[meta_keywords]' id='meta_keywords' class='form-control' row='3'><?php echo $setting['meta_keywords']; ?></textarea></td>
                    </tr>
                    <tr>
                        <td ><strong><?php echo $this->lang->line('meta_description'); ?></td>
                        <td><textarea name='setting[meta_description]' id='meta_description' class='form-control' row='3'><?php echo $setting['meta_description']; ?></textarea></td>
                    </tr>
                </table>
            </div>
